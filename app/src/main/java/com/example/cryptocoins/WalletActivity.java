...
public class WalletActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wid.setText(sp.getString("WALLETID","YOK"));
        ...
        change.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(WalletActivity.this,AddWalletID.class));
        ...
        queue.add(new StringRequest(Request.Method.GET,
                "https://blockchain.info/q/addressbalance/"+sp.getString("WALLETID","YOK"),
        ...
        queue.add(new JsonObjectRequest(Request.Method.GET,
                "https://blockchain.info/rawaddr/"+sp.getString("WALLETID","YOK"),null,
